...
const VOCAB_INDEX = {
  ...
  "Useful Phrases": {
    ...
    words: [
      ...
      { r: "gochisousama deshita", jp: "ごちそうさまでした", en: "thank you for the meal" },
  ...
  "Greetings": {
    ...
    color: "#f472b6",
    words: [
      { r: "konnichiwa", jp: "こんにちは", en: "hello" },
      { r: "ohayou gozaimasu", jp: "おはようございます", en: "good morning (polite)" },
      { r: "ohayou", jp: "おはよう", en: "good morning (casual)" },
      { r: "konbanwa", jp: "こんばんは", en: "good evening" },
      { r: "oyasumi nasai", jp: "おやすみなさい", en: "good night (polite)" },
      { r: "oyasumi", jp: "おやすみ", en: "good night (casual)" },
      { r: "sayounara", jp: "さようなら", en: "goodbye (formal)" },
      { r: "ja ne", jp: "じゃね", en: "bye (casual)" },
      { r: "mata ne", jp: "またね", en: "see you later" },
      { r: "mata ashita", jp: "またあした", en: "see you tomorrow" },
      { r: "ogenki desu ka", jp: "おげんきですか", en: "how are you?" },
      { r: "genki desu", jp: "げんきです", en: "I'm fine" },
      { r: "ohisashiburi", jp: "おひさしぶり", en: "long time no see" },
      { r: "itterasshai", jp: "いってらっしゃい", en: "have a good trip (said to someone leaving)" },
      { r: "ittekimasu", jp: "いってきます", en: "I'm heading out" },
      { r: "tadaima", jp: "ただいま", en: "I'm home" },
      { r: "okaeri nasai", jp: "おかえりなさい", en: "welcome home" },
    ]
  },
  "At Restaurants": {
    icon: "🍜",
    color: "#ef4444",
    words: [
      { r: "sumimasen", jp: "すみません", en: "excuse me (to get attention)" },
      { r: "kore kudasai", jp: "これください", en: "I'll have this" },
      { r: "osusume wa nan desu ka", jp: "おすすめはなんですか", en: "what do you recommend?" },
      { r: "omizu kudasai", jp: "おみずください", en: "water please" },
      { r: "okaikei onegaishimasu", jp: "おかいけいおねがいします", en: "check please" },
      { r: "itadakimasu", jp: "いただきます", en: "bon appétit (before eating)" },
      { r: "gochisousama deshita", jp: "ごちそうさまでした", en: "thank you for the meal" },
      { r: "oishii desu", jp: "おいしいです", en: "it's delicious" },
      { r: "menyuu kudasai", jp: "メニューください", en: "menu please" },
      { r: "biiru o nihai onegaishimasu", jp: "ビールをにはいおねがいします", en: "two beers please" },
      { r: "kore wa nan desu ka", jp: "これはなんですか", en: "what is this?" },
      { r: "arerugii ga arimasu", jp: "アレルギーがあります", en: "I have an allergy" },
      { r: "niku nashi de onegaishimasu", jp: "にくなしでおねがいします", en: "without meat please" },
    ]
  },
  "Shopping": {
    icon: "🛍️",
    color: "#a855f7",
    words: [
      { r: "ikura desu ka", jp: "いくらですか", en: "how much is this?" },
      { r: "kurejitto kaado tsukaemasu ka", jp: "クレジットカードつかえますか", en: "can I use credit card?" },
      { r: "kore ni shimasu", jp: "これにします", en: "I'll take this" },
      { r: "mite iru dake desu", jp: "みているだけです", en: "just looking" },
      { r: "motto yasui no arimasu ka", jp: "もっとやすいのありますか", en: "do you have something cheaper?" },
      { r: "S / M / L saizu", jp: "S / M / Lサイズ", en: "small / medium / large size" },
      { r: "kore wa seeruhin desu ka", jp: "これはセールひんですか", en: "is this on sale?" },
      { r: "fukuro wa iranai desu", jp: "ふくろはいらないです", en: "I don't need a bag" },
      { r: "reshiito kudasai", jp: "レシートください", en: "receipt please" },
    ]
  },
  "Filler Words": {
    icon: "🤔",
    color: "#f97316",
    words: [
      { r: "anou", jp: "あのう", en: "uh... / um..." },
      { r: "etto", jp: "えっと", en: "ummm... (thinking)" },
      { r: "maa", jp: "まあ", en: "well..." },
      { r: "nanka", jp: "なんか", en: "like... / somehow" },
      { r: "yappari", jp: "やっぱり", en: "I knew it / as I thought" },
      { r: "uun", jp: "うーん", en: "hmm..." },
      { r: "tashikani", jp: "たしかに", en: "that's true / indeed" },
      { r: "sou sou", jp: "そうそう", en: "yeah yeah / exactly" },
      { r: "teiuka", jp: "ていうか", en: "I mean / or rather" },
      { r: "chotto", jp: "ちょっと", en: "a little / um..." },
      { r: "sou desu ne", jp: "そうですね", en: "that's right / let me think" },
      { r: "naruhodo", jp: "なるほど", en: "I see / makes sense" },
      { r: "maji de", jp: "まじで", en: "seriously? / for real?" },
      { r: "sugoi", jp: "すごい", en: "amazing / wow" },
      { r: "yabai", jp: "やばい", en: "crazy / awesome / oh no (slang)" },
      { r: "betsu ni", jp: "べつに", en: "not really / nothing special" },
    ]
  },
};
